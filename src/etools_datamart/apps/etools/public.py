...
# class PartnerOrganization2(PartnerOrganization):
...
#     tenantflag = models.ForeignKey(EnvironmentTenantflag, models.DO_NOTHING)
#     country = models.ForeignKey('UsersCountry', models.DO_NOTHING)
#
#     class Meta:
#         managed = False
#         db_table = 'environment_tenantflag_countries'
#         unique_together = (('tenantflag', 'country'),)
#
#
...
#         unique_together = (('tenantflag', 'group'),)
#
#
...
#     tenantswitch = models.ForeignKey(EnvironmentTenantswitch, models.DO_NOTHING)
#     country = models.ForeignKey('UsersCountry', models.DO_NOTHING)
#
#     class Meta:
#         managed = False
#         db_table = 'environment_tenantswitch_countries'
#         unique_together = (('tenantswitch', 'country'),)
#
#
...
#     sent_email = models.ForeignKey('PostOfficeEmail', models.DO_NOTHING, blank=True, null=True)
...
#     region = models.ForeignKey('PublicsBusinessregion', models.DO_NOTHING)
#     default_currency = models.ForeignKey('PublicsCurrency', models.DO_NOTHING, blank=True, null=True)
#     deleted_at = models.DateTimeField()
#
#     class Meta:
#         managed = False
...
#     region = models.ForeignKey('PublicsDsaregion', models.DO_NOTHING)
#
#     class Meta:
#         managed = False
...
#     country = models.ForeignKey(PublicsCountry, models.DO_NOTHING)
#     deleted_at = models.DateTimeField()
...
#     fund = models.ForeignKey(PublicsFund, models.DO_NOTHING)
#
#     class Meta:
#         managed = False
...
#     country = models.ForeignKey(PublicsCountry, models.DO_NOTHING)
#     expense_type = models.ForeignKey('PublicsTravelexpensetype', models.DO_NOTHING, unique=True)
#     deleted_at = models.DateTimeField()
#
#     class Meta:
#         managed = False
...
#     wbs = models.ForeignKey(PublicsWbs, models.DO_NOTHING)
#     grant = models.ForeignKey(PublicsGrant, models.DO_NOTHING)
#
#     class Meta:
#         managed = False
#         db_table = 'publics_wbs_grants'
#         unique_together = (('wbs', 'grant'),)
#
#
...
#     auditor_firm = models.ForeignKey(PurchaseOrderAuditorfirm, models.DO_NOTHING)
...
#     purchase_order = models.ForeignKey(PurchaseOrderPurchaseorder, models.DO_NOTHING)
#
#     class Meta:
#         managed = False
...
#     tpmpartner = models.ForeignKey(TpmpartnersTpmpartner, models.DO_NOTHING)
#     country = models.ForeignKey('UsersCountry', models.DO_NOTHING)
#
#     class Meta:
#         managed = False
...
#     local_currency = models.ForeignKey(PublicsCurrency, models.DO_NOTHING, blank=True, null=True)
...
#     country = models.ForeignKey(UsersCountry, models.DO_NOTHING)
#     section = models.ForeignKey('UsersSection', models.DO_NOTHING)
#
#     class Meta:
#         managed = False
#         db_table = 'users_country_sections'
#         unique_together = (('country', 'section'),)
#
#
# class UsersEquitrackregistrationmodel(models.Model):
#     registrationprofile_ptr = models.ForeignKey(RegistrationRegistrationprofile, models.DO_NOTHING, primary_key=True)
#
#     class Meta:
#         managed = False
#         db_table = 'users_equitrackregistrationmodel'
#
#
# class UsersOffice(models.Model):
#     name = models.CharField(max_length=254)
#     zonal_chief = models.ForeignKey(AuthUser, models.DO_NOTHING, blank=True, null=True)
#
#     class Meta:
#         managed = False
...
#     country = models.ForeignKey(UsersCountry, models.DO_NOTHING, blank=True, null=True)
...
#     user_id = models.IntegerField(unique=True)
#     country_override = models.ForeignKey(UsersCountry, models.DO_NOTHING, blank=True, null=True)
...
#     oic = models.ForeignKey(AuthUser, models.DO_NOTHING, blank=True, null=True)
...
#     workspace = models.ForeignKey(UsersCountry, models.DO_NOTHING, unique=True)
#
#     class Meta:
#         managed = False
