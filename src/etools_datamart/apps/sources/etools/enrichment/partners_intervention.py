...
PartnersIntervention.total_unicef_cash = property(
    lambda self: (
        self.PartnersInterventionbudget_intervention.unicef_cash_local
...
PartnersIntervention.total_in_kind_amount = property(
    lambda self: (
        self.PartnersInterventionbudget_intervention.in_kind_amount_local
        if hasattr(self, "PartnersInterventionbudget_intervention")
        else 0
    )
)
...
PartnersIntervention.total_partner_contribution = property(
    lambda self: (
        self.PartnersInterventionbudget_intervention.partner_contribution_local
        if hasattr(self, "PartnersInterventionbudget_intervention")
        else 0
    )
)
