...
backward_compatible_router.register(r'prp/clusterclusterobjectivelocations',
                                    api.ClusterClusterobjectiveLocationsViewSet)
backward_compatible_router.register(r'prp/corecartodbtable', api.CoreCartodbtableViewSet)
backward_compatible_router.register(r'prp/corecountry', api.CoreCountryViewSet)
backward_compatible_router.register(r'prp/coregatewaytype', api.CoreGatewaytypeViewSet)
...
backward_compatible_router.register(r'prp/coreworkspacecountries', api.CoreWorkspaceCountriesViewSet)
...
backward_compatible_router.register(r'prp/indicatorreportabledisaggregations',
                                    api.IndicatorReportableDisaggregationsViewSet)
...
backward_compatible_router.register(r'prp/partnerpartneractivityprojectcontext',
                                    api.PartnerPartneractivityprojectcontextViewSet)
backward_compatible_router.register(r'prp/partnerpartnerproject', api.PartnerPartnerprojectViewSet)
backward_compatible_router.register(r'prp/partnerpartnerprojectadditionalpartners',
                                    api.PartnerPartnerprojectAdditionalPartnersViewSet)
...
backward_compatible_router.register(r'prp/unicefprogrammedocumentpartnerfocalpoint',
                                    api.UnicefProgrammedocumentPartnerFocalPointViewSet)
backward_compatible_router.register(r'prp/unicefprogrammedocumentsections', api.UnicefProgrammedocumentSectionsViewSet)
backward_compatible_router.register(r'prp/unicefprogrammedocumentuniceffocalpoint',
                                    api.UnicefProgrammedocumentUnicefFocalPointViewSet)
backward_compatible_router.register(r'prp/unicefprogrammedocumentunicefofficers',
                                    api.UnicefProgrammedocumentUnicefOfficersViewSet)
