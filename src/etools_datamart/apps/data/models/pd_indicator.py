...
from etools_datamart.apps.data.models import Location, Intervention
from etools_datamart.apps.data.models.base import DataMartModel
from etools_datamart.apps.etools.models import ReportsAppliedindicator, models


class PDIndicatorLoader(Loader):

    # def get_values(self, country, record, context):
    #     record is Location here
    # record.disaggr
    # return super().get_values(country, record, context)

    def process_record(self, filters, values, context):
        return super().process_record(filters, values, context)
    ...
    #
    #     for disaggregation in ReportsDisaggregation
...
class PDIndicator(DataMartModel):
    ...
    # from lower_result
    lower_result_name = models.CharField(max_length=45, blank=True, null=True)
    ...
    # from disaggregation
    disaggregation_name = models.CharField(max_length=255, unique=True)
