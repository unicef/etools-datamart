        ...
        for partner in self.get_queryset():
            for intervention in PartnersIntervention.objects.filter(agreement__partner=partner):
                ...
                values = {
                    ...
                    "currency": intervention.PartnersInterventionbudget_intervention.currency
                    if planned_budget
                    else "-",
                    "partner_contribution": intervention.PartnersInterventionbudget_intervention.partner_contribution
                    if planned_budget
                    else "-",
                    "unicef_cash": intervention.PartnersInterventionbudget_intervention.unicef_cash
                    if planned_budget
                    else "-",
                    "in_kind_amount": intervention.PartnersInterventionbudget_intervention.in_kind_amount
                    if planned_budget
                    else "-",
