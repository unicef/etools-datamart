...
class InterventionCountryProgrammeLoader(EtoolsLoader):
    ...
    FROM "partners_intervention_country_programmes";
    ...
    FROM "partners_intervention_country_programmes"
    INNER JOIN "partners_intervention" ON ("partners_intervention_country_programmes"."intervention_id" = "partners_intervention"."id")
    INNER JOIN "partners_agreement" ON ("partners_intervention"."agreement_id" = "partners_agreement"."id")
    NNER JOIN "partners_partnerorganization" ON ("partners_agreement"."partner_id" = "partners_partnerorganization"."id")
    INNER JOIN "organizations_organization" ON ("partners_partnerorganization"."organization_id" = "organizations_organization"."id")
    INNER JOIN "reports_countryprogramme" ON ("partners_intervention_country_programmes"."countryprogramme_id" = "reports_countryprogramme"."id")
    ORDER BY "partners_intervention_country_programmes"."id" ASC
