...
# Generated on 2019-08-14 07:41:06.830020
...
class AccountUserGroups(models.Model):
    user = models.ForeignKey(AccountUser, models.PROTECT, related_name='+')
...
class AccountUserUserPermissions(models.Model):
    user = models.ForeignKey(AccountUser, models.PROTECT, related_name='+')
    permission = models.ForeignKey('AuthPermission', models.PROTECT, related_name='+')
...
class AccountUserprofile(models.Model):
    ...
    user = models.OneToOneField(AccountUser, models.PROTECT, related_name='+')
...
class ClusterCluster(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('type', 'imported_type', 'response_plan'), ('external_id', 'external_source'),)
...
class ClusterClusteractivity(models.Model):
    ...
    cluster_objective = models.ForeignKey('ClusterClusterobjective', models.PROTECT, related_name='+')
...
class ClusterClusteractivityLocations(models.Model):
    clusteractivity = models.ForeignKey(ClusterClusteractivity, models.PROTECT, related_name='+')
...
class ClusterClusterobjective(models.Model):
    ...
    external_source = models.TextField(blank=True, null=True)
    title = models.TextField()
    cluster = models.ForeignKey(ClusterCluster, models.PROTECT, related_name='+')
...
class ClusterClusterobjectiveLocations(models.Model):
    clusterobjective = models.ForeignKey(ClusterClusterobjective, models.PROTECT, related_name='+')
    location = models.ForeignKey('CoreLocation', models.PROTECT, related_name='+')
...
class CoreCartodbtable(models.Model):
    ...
    country = models.ForeignKey('CoreCountry', models.PROTECT, related_name='+')
    location_type = models.ForeignKey('CoreGatewaytype', models.PROTECT, related_name='+')
...
class CoreLocation(models.Model):
    ...
    carto_db_table = models.ForeignKey(CoreCartodbtable, models.PROTECT, related_name='+', blank=True, null=True)
    gateway = models.ForeignKey(CoreGatewaytype, models.PROTECT, related_name='+')
    parent = models.ForeignKey('self', models.PROTECT, related_name='+', blank=True, null=True)
    level = models.IntegerField()
    lft = models.IntegerField()
    rght = models.IntegerField()
...
class CorePrprole(models.Model):
    ...
    cluster = models.ForeignKey(ClusterCluster, models.PROTECT, related_name='+', blank=True, null=True)
    user = models.ForeignKey(AccountUser, models.PROTECT, related_name='+')
...
class PartnerPartneractivity(models.Model):
    ...
    modified = models.DateTimeField()
    title = models.CharField(max_length=2048)
    cluster_activity = models.ForeignKey(ClusterClusteractivity, models.PROTECT, related_name='+', blank=True, null=True)
    cluster_objective = models.ForeignKey(ClusterClusterobjective, models.PROTECT, related_name='+', blank=True, null=True)
    partner = models.ForeignKey(PartnerPartner, models.PROTECT, related_name='+')
...
class UnicefNotificationNotification(models.Model):
    ...
    content_type = models.ForeignKey(DjangoContentType, models.PROTECT, related_name='+', blank=True, null=True)
    sent_email = models.ForeignKey('PostOfficeEmail', models.PROTECT, related_name='+', blank=True, null=True)
...
class UnicefProgressreport(models.Model):
    ...
    programme_document = models.ForeignKey(UnicefProgrammedocument, models.PROTECT, related_name='+')
    submitted_by = models.ForeignKey(AccountUser, models.PROTECT, related_name='+', blank=True, null=True)
    submitting_user = models.ForeignKey(AccountUser, models.PROTECT, related_name='+', blank=True, null=True)
