...
router.register(r"datamart/interventions-activities", endpoints.InterventionActivityViewSet)
...
router.register(r"datamart/partners/assessment", endpoints.PartnerAssessmentViewSet)
