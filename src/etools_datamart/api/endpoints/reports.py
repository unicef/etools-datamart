...
class ReportsResultViewSet(common.ReadOnlyModelViewSet):
    serializer_class = serializers.ReportsResultSerializer
    queryset = models.ReportsResult.objects.select_related('result_type')


class ReportsResultTypeViewSet(common.ReadOnlyModelViewSet):
    serializer_class = serializers.ReportsResultSerializer
    queryset = models.ReportsResult.objects.select_related('result_type')


class AppliedindicatorViewSet(common.ReadOnlyModelViewSet):
